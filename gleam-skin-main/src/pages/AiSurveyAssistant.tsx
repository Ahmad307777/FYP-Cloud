...
import { Sparkles, Loader2, Send, Bot, User, ArrowLeft, Mic, MicOff } from "lucide-react";
...
const AiSurveyAssistant = () => {
        ...
        if (SpeechRecognition) {
            ...
            recognition.onerror = (event: any) => {
                ...
                toast({
                    ...
                    description: "Make sure you have granted microphone permissions.",
                    variant: "destructive",
                });
            };
    ...
    const toggleListening = () => {
        ...
        if (isListening) {
            ...
            setInput(""); // Optional: clear input when starting voice or append? User choice. Let's append if not empty.
            recognitionRef.current.start();
            setIsListening(true);
            toast({
                title: "Listening...",
                description: "Go ahead, describe your survey goals.",
            });
        }
    };
    ...
    const handleSendMessage = async () => {
        ...
        if (userMessage.toLowerCase().includes("done")) {
            ...
            try {
                ...
                // Navigate to Create Survey page (Builder) with generated data
                navigate("/create", {
                    state: {
                        generatedSurvey: {
                    ...
                    <div className="p-4 bg-white border-t">
                        <div className="relative flex items-end gap-2 max-w-4xl mx-auto">
                            <div className="relative flex-1">
                                <Textarea
                                    ...
                                    placeholder={isListening ? "Listening... Speak clearly." : "Describe your survey (e.g., 'Customer satisfaction survey')..."}
                                    className={`min-h-[60px] max-h-[150px] resize-none pr-12 text-base py-3 rounded-xl border-gray-200 focus:border-primary focus:ring-primary/20 transition-colors ${isListening ? 'bg-red-50/50 border-red-200 ring-red-500/10' : ''}`}
                                ...
                                <div className="absolute right-2 bottom-2 flex gap-1">
                                    <Button
                                        ...
                                        disabled={isChatting || isGenerating}
                                        variant="ghost"
                                        className={`h-10 w-10 p-0 rounded-lg transition-all ${isListening ? 'text-red-500 bg-red-50 hover:bg-red-100 animate-pulse' : 'text-gray-400 hover:text-primary hover:bg-primary/5'}`}
                                    ...
                                    <Button
                                        ...
                                        disabled={isChatting || isGenerating || (!input.trim() && !isListening)}
                                        className="h-10 w-10 p-0 rounded-lg bg-primary hover:bg-primary/90 transition-all text-white shadow-lg shadow-primary/20"
                                    >
                        ...
                        <div className="flex justify-center gap-4 mt-3">
                            <p className="text-xs text-muted-foreground">
                                Tip: Say <strong>"done"</strong> to generate.
                            </p>
                            {isListening && (
