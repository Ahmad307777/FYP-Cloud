...
from .views import (
    ...
    generate_options, generate_image_view, analyze_survey_view, audit_quality,
...
urlpatterns = [
    ...
    path('ai/analyze/', analyze_survey_view, name='analyze-survey'),
    path('ai/audit-quality/', audit_quality, name='audit-quality'),
    path('ai/generate-qualification/', generate_qualification, name='generate-qualification'),
]
